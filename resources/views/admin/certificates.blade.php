      ...
      <table class="w-full">
        ...
        <tbody class=" bg-white rounded-md dark:bg-darker dark:border-primary text-gray-500 dark:text-light text-gray-500 dark:text-light">
          ...
          <tr class="text-gray-700 text-gray-500 dark:text-light">
            <td class="px-4 py-3">{{ $certificate->serial }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $certificate->type }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $certificate->name }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $certificate->edition }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $certificate->grade }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $certificate->created_at->diffForHumans() }}</td>
            <td class="px-4 py-3 text-xs">
              <form action="../archives" method="post">
                @csrf
                <input type="hidden" name="serial" value="{{$certificate->serial}}">
                <button type="submit" class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm">View</button>
              </form>
            </td>
          </tr>
         @endforeach
