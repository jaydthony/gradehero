...
<!-- Import -->
<form action="/admin/profile/{{$user->id}}" method="POST" class="container mx-auto p-6 font-mono bg-white rounded-md dark:bg-darker dark:border-primary dark:bg-darker dark:border-primary text-gray-500 dark:text-light">
  @csrf
  @method('PUT')
