        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <main>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              <h1 class="text-2xl font-semibold">Generate Certificate</h1>
              {{-- <a
                href="#"
                target="_blank"
...
<!-- Import -->
<form action="/admin/updateCertificate/{{$certificate->id}}" method="POST" class="container mx-auto p-6 font-mono bg-white rounded-md dark:bg-darker dark:border-primary dark:bg-darker dark:border-primary text-gray-500 dark:text-light">
  @csrf
  @method('PUT')
  @php
