      ...
      <table class="w-full">
        ...
        <tbody class=" bg-white rounded-md dark:bg-darker dark:border-primary text-gray-500 dark:text-light text-gray-500 dark:text-light">
          ...
          <tr class="text-gray-700 text-gray-500 dark:text-light">
            <td class="p-2 text-ms font-semibold"><img src="{{asset("attachments/". $message->file)}}" alt="attachment"></td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $message->name }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $message->email }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $message->desc }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $message->created_at->diffForHumans() }}</td>
            <td class="px-4 py-3 text-xs">
              <a href="mailto:{{$message->email}}"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> Message </span></a> 
            </td>
          </tr>
         @endforeach
        </tbody>
