        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <main>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              <h1 class="text-2xl font-semibold">Graded Cards</h1>
              {{-- <a
                href="#"
                target="_blank"
      ...
      <table class="w-full">
        <thead>
          <tr class="text-md font-semibold tracking-wide text-left dark:bg-darker dark:border-primary text-gray-500 dark:text-light uppercase border-b">
            ...
            <th class="px-4 py-3">Admin Desc</th>
            <th class="px-4 py-3">Graded</th>
        ...
        <tbody class=" bg-white rounded-md dark:bg-darker dark:border-primary text-gray-500 dark:text-light text-gray-500 dark:text-light">
          ...
          <tr class="text-gray-700 text-gray-500 dark:text-light">
            ...
            <td class="px-4 py-3 text-ms font-semibold">
              @if($grade->rating == "poor") 
              Poor
              @elseif($grade->rating == "good")
              Good
              @elseif($grade->rating == "very_good")
              Very Good
              @elseif($grade->rating == "very_good-excellent")
              Very Good - Excellent
              @elseif($grade->rating == "excellent")
              Excellent
              @elseif($grade->rating == "excellent-mint")
              Excellent - Mint
              @elseif($grade->rating == "near_mint")
              Near Mint
              @elseif($grade->rating == "near_mint-mint")
              Near Mint - Mint
              @elseif($grade->rating == "mint")
              Mint
              @elseif($grade->rating == "mint_plus")
              Mint +
              @else
              Gem Mint
              @endif
            </td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $grade->admin_desc }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $grade->created_at->diffForHumans() }}</td>
            <td class="px-4 py-3 text-xs">
              @if ($certificates->where('grade_id', $grade->id)->first())
              @php 
                $certificate = $certificates->where('grade_id', $grade->id)->first()
              @endphp
              <a href="/admin/edit-certificate/{{$certificate->id}}"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-red-100 rounded-sm"> Generated </span></a> 
              @else
              <a href="/admin/issue-certificate/{{$grade->id}}"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> Generate </span></a> 
              @endif
            </td>
          </tr>
          @endif
