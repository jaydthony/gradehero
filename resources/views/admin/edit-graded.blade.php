        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <main>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              <h1 class="text-2xl font-semibold">Card Grading</h1>
              {{-- <a
                href="#"
                target="_blank"
...
<!-- Import -->
<form action="/admin/updateGraded/{{$grade->id}}" method="POST" class="container mx-auto p-6 font-mono bg-white rounded-md dark:bg-darker dark:border-primary dark:bg-darker dark:border-primary text-gray-500 dark:text-light">
  @csrf
  @method('PUT')
  @php
    $card = $cards->find($grade->card_id);
  @endphp
  <div class="flex flex-wrap -mx-3 p-6 mb-6">
    <input 
    type="hidden" 
    name="card_id" 
    value="{{$card->id}}"
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
      <label class="block uppercase tracking-wide text-xs font-bold mb-2" for="grid-first-name">
        Card Holder <small>[email]</small> 
      </label>
      <input 
      class="dark:bg-darker border dark:border-primary dark:bg-darker text-gray-500 dark:text-light appearance-none block w-full rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" 
      id="grid-first-name" 
      type="text" 
      value="{{$card->email}}"
      readonly>
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      <input class="dark:bg-darker border dark:border-primary dark:bg-darker text-gray-500 dark:text-light appearance-none block w-full rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" 
      id="grid-last-name" 
      type="text" 
      value="{{$card->series}}"
      readonly>
  ...
  <div class="flex flex-wrap -mx-3 p-6 mb-6">
    ...
    <div class="w-full md:w-1/2 px-3">
      ...
      id="grid-last-name" 
      type="text" 
      value="{{$card->created_at->diffForHumans()}}"
      readonly>
    </div>
  </div>
  <div class="flex flex-wrap -mx-3 p-6 mb-6">
  ...
  <div class="flex flex-wrap -mx-3 p-6 mb-6">
    <div class="w-full px-3 mb-6 md:mb-0">
      ...
      class="dark:bg-darker border dark:border-primary dark:bg-darker text-gray-500 dark:text-light appearance-none block w-full rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" 
      >
        <option value="poor">1.0 - 1.5 [Poor]</option>
        <option value="good">2.0 - 2.5 [Good]</option>
        <option value="very_good">3.0 - 3.5 [Very Good]</option>
        <option value="very_good-excellent">4.0 - 4.5 [Very Good - Excellent]</option>
        <option value="excellent">5.0 - 5.5 [Excellent]</option>
        <option value="excellent-mint">6.0 - 6.5 [Excellent - Mint]</option>
        <option value="near_mint">7.0 - 7.5 [Near Mint]</option>
        <option value="near_mint-mint">8.0 - 8.5 [Near Mint - Mint]</option>
        <option value="mint">9.0 - 9.0 [Mint]</option>
        <option value="mint_plus">9.5 - 9.5 [Mint +]</option>
        <option value="gem_mint">10.0 - 10.0 [Gem Mint]</option>
    </select>
    @error('rating')
