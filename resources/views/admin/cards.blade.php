...
<html lang="en">
  <head>
    ...
    <title>Gradehero Dashboard</title>
    <link
            ...
            <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm"> Evaluate Cards </span>
              ...
              <div x-data="{ isActive: false, open: false }">
                ...
                >
                  ...
                  <span class="ml-2 text-sm"> Certificates </span>
                  <span aria-hidden="true" class="ml-auto">
                    <!-- active class 'rotate-180' -->
                    <svg
                      class="w-4 h-4 transition-transform transform"
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
              ...
              <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                ...
                <div class="relative" x-data="{ open: false }">
                  ...
                  >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{asset('Gradehero-imgs/avatar.png')}}" alt="Admin" />
                  </button>
          ...
          <main>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              <h1 class="text-2xl font-semibold">All Cards</h1>
              {{-- <a
                href="#"
                target="_blank"
...
<section class="container mx-auto p-6 font-mono">
  <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg bg-white rounded-md dark:bg-darker dark:border-primary">
    <div class="w-full overflow-x-auto">
      <table class="w-full">
        <thead>
          <tr class="text-md font-semibold tracking-wide text-left dark:bg-darker dark:border-primary text-gray-500 dark:text-light uppercase border-b">
            <th class="px-4 py-3">#</th>
            <th class="px-4 py-3">Email</th>
            <th class="px-4 py-3">Series</th>
            <th class="px-4 py-3">Service</th>
            <th class="px-4 py-3">Speed</th>
            {{-- <th class="px-4 py-3">Worn edges</th> --}}
            {{-- <th class="px-4 py-3">Creases</th> --}}
            {{-- <th class="px-4 py-3">Scratches</th> --}}
            {{-- <th class="px-4 py-3">Worn corners</th> --}}
        ...
        <tbody class=" bg-white rounded-md dark:bg-darker dark:border-primary text-gray-500 dark:text-light text-gray-500 dark:text-light">
            @foreach($cards as $card)
          <tr class="text-gray-700 text-gray-500 dark:text-light">
            <td class="px-4 py-3">{{ $card->id }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->email }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->series }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->service }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->speed }}</td>
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->worn_edges }}</td> --}}
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->creases }}</td> --}}
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->scratches }}</td> --}}
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->worn_corners }}</td> --}}
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->comment }}</td> --}}
            {{-- <td class="px-4 py-3 text-ms font-semibold">{{ $card->qty }}</td> --}}
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->desc }}</td>
            <td class="px-4 py-3 text-ms font-semibold">{{ $card->created_at->diffForHumans() }}</td>
            <td class="px-4 py-3 text-xs">
              @if ($graded->where('card_id', $card->id)->first())
              @php 
                $grade = $graded->where('card_id', $card->id)->first()
              @endphp
              <a href="/admin/edit-graded/{{$grade->id}}"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-red-100 rounded-sm"> Graded </span></a>
              @else
              <a href="/admin/grade/{{$card->id}}"><span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> Grade </span></a>
              @endif
            </td>
          </tr>
         @endforeach
...
<!-- Table -->
          ...
          >
            <div>Gradehero &copy; 2023</div>
            <div>
              Made with
              <a href="#" target="_blank" class="text-pink-500 hover:underline"
                >Love</a
              >
            </div>
          </footer>
          ...
          <div class="flex flex-col h-screen" x-data="{ activeTabe: 'action' }">
            ...
            <div class="flex-1 pt-4 overflow-y-hidden hover:overflow-y-auto">
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'action'">
                @foreach($cards as $card)
                <a href="/admin/cards" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">
                        New card "{{ $card->email }}" uploaded
                      </h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                       {{ $card->desc }}
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> {{ $card->created_at->diffForHumans() }} </span>
                    </div>
                  </div>
                </a>
               @endforeach
              ...
              <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                ...
                <a href="/admin/issued-certificates" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">{{ $card->series }} card</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        Certificate issued for "{{ $card->email }}"
                      </p>
                      <span class="text-sm font-normal text-gray-400 dark:text-primary-light"> {{ $grade->updated_at->diffForHumans() }} </span>
                    </div>
                  </div>
                </a>
                @endif
