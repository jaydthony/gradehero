        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
          ...
          <main>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
              <h1 class="text-2xl font-semibold">Issued Certificate</h1>
              {{-- <a
                href="#"
                target="_blank"
        ...
        <div class="border">
          <div class="flex flex-row items-center justify-between px-2">
            ...
            <div class="flex flex-col space-y-2 text-right">
              <img src="/Gradehero-imgs/transparent 1.png" alt="Logo" class="h-[0.8rem] w-50">
              <p>{{$certificate->grade}}</p>
              <p>{{$certificate->serial}}</p>
            </div>
          </div>
          <div class="border">
            <img width="350px" height="350px" src="{{asset("storage/". $card->cert_img)}}" alt="{{$certificate->type}} certificate">
          </div>
